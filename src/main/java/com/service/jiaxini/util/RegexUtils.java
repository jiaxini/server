 ...
 * @author: liushen
 * 引用来自：
 * https://github.com/YUSHEN2015/RegexUtils/blob/master/RegexUtils.java
 */
public class RegexUtils {
    ...
    public static boolean checkTencent(String tencentNumber){
        String regex = "[1-9]\\d{4,11}";
        return Pattern.matches(regex, tencentNumber);
    }
}
